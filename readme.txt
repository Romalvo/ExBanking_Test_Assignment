test_server made on node.js
node.js should be installed.
Library k6 must be installed.
To run server need to run from the directory when the file located and in the terminal type: node test_server.js
